...
struct MultiVector{
  ...
  MultiVector times(MultiVector rhs) const{
    ...
    float _wyx = s*rhs.wyx - w*rhs.xy + x*rhs.wy - y*rhs.wx - wx*rhs.y + wy*rhs.x - xy*rhs.w + wyx*rhs.s + z*rhs.wxyz;
    float _wxz = s*rhs.wxz - w*rhs.zx - x*rhs.wz + z*rhs.wx + wx*rhs.z - wz*rhs.x - zx*rhs.w + wxz*rhs.s + y*rhs.wxyz;
    float _wzy = s*rhs.wzy - w*rhs.yz + y*rhs.wz - z*rhs.wy - wy*rhs.z + wz*rhs.y - yz*rhs.w + wzy*rhs.s + x*rhs.wxyz;
  ...
  MultiVector cross(MultiVector rhs){
    float _s = s*rhs.s;
    float _w = s*rhs.w + w*rhs.s;
    float _x = s*rhs.x + x*rhs.s + y*rhs.z - z*rhs.y ;
    float _y = s*rhs.y + y*rhs.s + z*rhs.x - x*rhs.z;
    float _z = s*rhs.z + z*rhs.s + x*rhs.y - y*rhs.x;
    float _wx = s*rhs.wx + w*rhs.x - x*rhs.w + wx*rhs.s;
    float _wy = s*rhs.wy + w*rhs.y - y*rhs.w + wy*rhs.s;
    float _wz = s*rhs.wz + w*rhs.z - z*rhs.w + wz*rhs.s;
    float _xy = s*rhs.x + xy*rhs.s;
    float _zx = s*rhs.zx + zx*rhs.s;
    float _yz = s*rhs.yz + yz*rhs.s;
    float _wyx = s*rhs.wyx - w*rhs.xy + x*rhs.wy - y*rhs.wx - wx*rhs.y + wy*rhs.x - xy*rhs.w + wyx*rhs.s;
    float _wxz = s*rhs.wxz - w*rhs.zx - x*rhs.wz + z*rhs.wx + wx*rhs.z - wz*rhs.x - zx*rhs.w + wxz*rhs.s;
    float _wzy = s*rhs.wzy - w*rhs.yz + y*rhs.wz - z*rhs.wy - wy*rhs.z + wz*rhs.y - yz*rhs.w + wzy*rhs.s;
    float _xyz = s*rhs.xyz + x*rhs.yz + y*rhs.zx + z*rhs.xy + xy*rhs.z + zx*rhs.y + yz*rhs.x + xyz*rhs.s;
